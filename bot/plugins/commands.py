...
async def start(bot, update):
        ...
        try:
            ...
            await update.reply_text(
                ...
                reply_markup=InlineKeyboardMarkup([
                    [ InlineKeyboardButton(text=" 💢 𝙹𝚘𝚒𝚗 our channel 💢 ", url=f"https://t.me/MF_MOVIES1")]
              ])
            )
            return
        except Exception:
                    ...
                    [
                        [
                            InlineKeyboardButton
                                (
                                    '💿 OTT DVD UPDATES', url=f"{MT_CHANNEL}"
                                )
                        ],
                        [
                            InlineKeyboardButton
                                (
                                    'CHANNEL', url=f"{MT_BOT_UPDATES}"
                                )
                        ]
                    ]
                )
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton
                                (
                                    '👨‍💼 𝙳𝚎𝚟𝚎𝚕𝚘𝚙𝚎𝚛𝚜 👨‍💼', url="https://t.me/MF_CHATGROUP"
                                )
                        ]
                    ]
                )
    ...
    buttons = [[
        InlineKeyboardButton('JINN', url=f'https://t.me/JINN_OFF_TELEGRAM'),
...
async def about(bot, update):
    ...
    buttons = [[
        InlineKeyboardButton('JINN OF TG', url='https://t.me/JINN_OFF_TELEGRAM'),
